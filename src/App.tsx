  ...
  return (
    <div>
      <div style={{flex: 1, flexDirection: 'row', alignItems: 'center', width: '100%', height: '20%', backgroundColor: 'rgba(0,0,0,0.5)'}}>
        <button style={{backgroundColor: 'black', height: '8%', width: '12%', color: 'white'}} onClick={() => navigate("/defenses")}>Defenses</button>
      ...
      <Routes>
        ...
        <Route path={"/defenses"} element={Defenses(data.defenses)}/>
      </Routes>
    </div>
